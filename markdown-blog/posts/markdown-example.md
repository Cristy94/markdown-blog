...
class Parsedown
{
    ...
    protected function linesElements(array $lines)
    {
        ...
        foreach ($lines as $line)
        {
            ...
            {
                // CHANGED: Explicitly nullable type for $CurrentBlock
    ...
    // CHANGED: Explicitly nullable type for $Block
...
## `./markdown-blog/ParsedownExtra.php`
...
**Summary of changes:**
- Added `?array` type hint to the `$CurrentBlock` and `$Block` parameters in the relevant methods to make their nullability explicit and remove deprecation warnings.

No other files need to be changed for these deprecation warnings.
