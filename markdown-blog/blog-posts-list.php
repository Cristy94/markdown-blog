        ...
        <div class="col-12 col-lg-10 col-xl-8">
          <div class="blog">
            <header class="blog-header mb-5">
              <!-- get the AUTH_TOKEN from envronment -->
              <h1 class="blog-title"><? echo getenv('BLOG_TITLE') ?: 'My Blog'; ?></h1>
              <p class="blog-description text-muted"><? echo getenv('BLOG_DESCRIPTION')?: 'This is the blog description'; ?></p>
              <div class="blog-meta">
